...
no_button.addEventListener('click', () => {
    // Play fail sound
    const audio = new Audio('public/images/fail.wav');
    audio.play();
    // Change banner source
    if (clicks === 0) {
        let bannerContainer = document.querySelector('.banner-gif');
        bannerContainer.innerHTML = '<video id="banner" src="public/images/no.mp4" autoplay loop muted playsinline></video>';
    }
    clicks++;
...
yes_button.addEventListener('click', () => {
    ...
    let bannerContainer = document.querySelector('.banner-gif');
    bannerContainer.innerHTML = '<video id="banner" src="public/images/yes.mp4" autoplay loop muted playsinline></video>';
...
function changeLanguage() {
    ...
    if (language === "french") {
        ...
        successMessage.textContent = "Yepppie, ab Meri Biwi, Mera baccha wapas karo :3";
    }
}